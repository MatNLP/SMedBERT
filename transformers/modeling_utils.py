...
class PreTrainedModel(nn.Module):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path,speic='', *model_args, **kwargs):
...
#                           "https://github.com/google-research/google-research/issues/119 for more information.")
        ...
        if pretrained_model_name_or_path is not None:
            ...
            if pretrained_model_name_or_path in cls.pretrained_model_archive_map:
                ...
                elif os.path.isfile(os.path.join(pretrained_model_name_or_path, speic+WEIGHTS_NAME)):

                    # Load from a PyTorch checkpoint

                    archive_file = os.path.join(pretrained_model_name_or_path, speic+WEIGHTS_NAME)
