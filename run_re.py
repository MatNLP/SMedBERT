...
class OurENRIEDataset(Dataset):
    ...
    def __feature2tensor__(self, feature):
        ...
        return ((all_input_ids, all_segment_ids,all_input_mask, kc_entity_one_hop_ids,
                 ...
                 +(kc_entity_se_index, kc_entity_two_hop_labels, kc_entity_out_or_in, kc_entity_two_hop_rel_types,kc_entity_two_hop_types,kc_entity_infusion_pos,label)
                 )
    ...
    def __read_data__(self):
        fr = open(self.data_path, "rb")
        self.lines = torch.load(fr)
        fr.close()
...
def main():
    ...
    if args.do_train:
        ...
        eval_dataloader = DataLoader(eval_dataset, sampler=eval_sampler, batch_size=args.eval_batch_size,
                                      num_workers=6,prefetch_factor=4,pin_memory=True)
